...
CANONICAL_SCHEMAS = {
    ...
    "PRICING": {
        "fields": [
            ...
            {"name": "mrp_method", "type": "string", "role": "C", "required": False,
             "aliases": ["grid_reference_method", "grid_tariff_method"],
             "description": "Market Reference Price calculation method: utility_variable_charges_tou, utility_total_charges"},
            {"name": "mrp_included_components", "type": "list", "role": "S", "required": False,
             "aliases": ["included_components", "mrp_components"],
             "description": "Utility bill line items included in MRP calculation"},
            {"name": "mrp_excluded_components", "type": "list", "role": "S", "required": False,
             "aliases": ["excluded_components"],
             "description": "Utility bill line items excluded from MRP (e.g., VAT, demand charges)"},
            {"name": "mrp_time_window_start", "type": "string", "role": "C", "required": False,
             "aliases": ["operating_window_start"],
             "description": "MRP operating window start time (e.g., '06:00')"},
            {"name": "mrp_time_window_end", "type": "string", "role": "C", "required": False,
             "aliases": ["operating_window_end"],
             "description": "MRP operating window end time (e.g., '18:00')"},
            {"name": "mrp_calculation_due_days", "type": "number", "role": "C", "required": False,
             "aliases": ["recalculation_deadline_days"],
             "description": "Days after month-end for MRP calculation delivery"},
            {"name": "mrp_verification_deadline_days", "type": "number", "role": "C", "required": False,
             "aliases": ["verification_days", "joint_verification_days"],
             "description": "Days for joint verification of MRP after receipt"},
