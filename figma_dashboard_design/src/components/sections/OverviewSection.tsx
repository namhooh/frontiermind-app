  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="space-y-6">
        <h1 className="text-slate-900 font-[Libre_Baskerville] text-[24px] font-bold">Payment Settlement and Compliance</h1>
                            ...
                            <div key={ppaIndex} className="flex items-center justify-between py-2 border-b border-slate-100 last:border-b-0">
                              <div className="flex flex-col">
                                ...
                                {project.projectName === "Sunfield Solar Park" && (
                                  <span className="text-xs text-red-600 italic">Annal escalation applied</span>
                                )}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center justify-between pt-2 border-t border-slate-100">
                            <div>
                              ...
                              <p className="text-[rgb(0,0,0)]">{project.finalBill}</p>
                            </div>
