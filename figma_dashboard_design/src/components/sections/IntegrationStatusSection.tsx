import image_e057346b5c69680c8ea6d15c6cbd188029f69caf from 'figma:asset/e057346b5c69680c8ea6d15c6cbd188029f69caf.png';
import image_45abfef21c0003fd0fb9e3cb32f0d66205de889a from 'figma:asset/45abfef21c0003fd0fb9e3cb32f0d66205de889a.png';
...
import snowflakeLogo from 'figma:asset/c4d5e14da3b974a2b83b5efe76b0c8136de87322.png';
import sapLogo from 'figma:asset/f2dddff10fce8c5cc0468d3c13d16d6eeadcbdb7.png';
import sageLogo from 'figma:asset/76faf8f617b56e6f079c5a7ead8f927f5a5fee32.png';
...
export function IntegrationStatusSection({ onSectionChange }: IntegrationStatusSectionProps) {
  ...
  return (
    <div className="p-8 space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-slate-900 mb-2 font-[Libre_Baskerville] text-2xl font-bold">Integration Status</h1>
      </div>
          ...
          <div className="flex items-center justify-between gap-6 py-8">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex flex-col items-center gap-2 text-xs text-slate-500">
                ...
                <img src={snowflakeLogo} alt="Snowflake Logo" className="w-28 h-16" />
              </div>
              <ArrowRight className="w-6 h-6 text-slate-400" />
            </div>
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="flex flex-col items-center gap-2 mt-4 text-xs text-slate-500">
                ...
                <div className="flex items-center gap-3">
                  <img src={image_45abfef21c0003fd0fb9e3cb32f0d66205de889a} alt="SAP Logo" className="w-18 h-10 object-contain" />
                  <img src={image_e057346b5c69680c8ea6d15c6cbd188029f69caf} alt="SAGE Logo" className="w-18 h-10 object-contain" />
                </div>
              </div>
            </div>
          </div>
