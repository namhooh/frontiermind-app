...
DROP FUNCTION IF EXISTS get_contract_pii_count(BIGINT);
DROP FUNCTION IF EXISTS log_pii_access(BIGINT);

-- Drop RLS policies
DROP POLICY IF EXISTS contract_pii_mapping_update_policy ON contract_pii_mapping;
DROP POLICY IF EXISTS contract_pii_mapping_insert_policy ON contract_pii_mapping;
DROP POLICY IF EXISTS contract_pii_mapping_select_policy ON contract_pii_mapping;

-- Drop indexes
DROP INDEX IF EXISTS idx_contract_pii_mapping_accessed_at;
DROP INDEX IF EXISTS idx_contract_pii_mapping_created_at;
DROP INDEX IF EXISTS idx_contract_pii_mapping_contract_id;

-- Drop table
DROP TABLE IF EXISTS contract_pii_mapping;
