...
export function Sidebar({ activeSection, onSectionChange }: SidebarProps) {
  const menuItems = [
    ...
    { id: "integration-status", label: "Integration Status", icon: Link },
    ...
    <div className="w-64 bg-white border-r border-slate-200 flex flex-col">
      <div className="p-6 border-b border-slate-200">
        <div className="flex items-center gap-3">
          <div>
            <h1 className="text-slate-900 font-bold" style={{ fontFamily: "'Libre Baskerville', serif" }}>FrontierMind</h1>
            <p className="text-slate-500 text-xs font-normal not-italic text-left text-[10px]">AI co-pilot for corporate energy projects</p>
          </div>
        </div>
      </div>
